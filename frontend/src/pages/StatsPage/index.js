...
class StatsPage extends React.Component {
  ...
  async componentDidMount() {
    ...
    try {
      ...
      const updateDate = parseISO(shortenedURL.updatedAt);
      const currentDate = new Date();
      const relativeDate = formatRelative(updateDate, currentDate, {locale: ptBR});
      ...
      <Container>
        ...
        {errorMessage ? (
          <StatsContainer className="text-center">
            ...
            <a className="btn brn-primary" href="/">Encurtar novas URL</a>
          </StatsContainer>
        ) : (
          <StatsContainer className="text-center">
            <p><b>https:///pitu.tk/{shortenedURL.code}</b></p>
            <p>Redireciona para: {shortenedURL.url}</p>
            <StatsRow>
              <StatsBox>
